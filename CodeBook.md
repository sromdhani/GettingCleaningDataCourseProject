# Code Book
This is a code book that explains that describes the different variables, we got 68 Variables

Here we describe for each variable its name, the type and the possible values

- subject: the subject number who did the experience,we have 30 subjects
